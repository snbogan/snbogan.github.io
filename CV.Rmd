...
subtitle: "Last updated July 11th, 2026"
---
<br>
...
Email: sbogan[at]skidmore.edu  

---

## Professional Appointments  

- 2026 — present — Assistant Professor, Skidmore College, Department of Biology, Saratoga Springs, NY
- 2023 – 2026 — Postdoctoral Researcher, University of California, Santa Cruz, Dept. of Ecology and Evolutionary Biology, Santa Cruz, CA
...
Thesis: *The Evolution of Plastic Responses to Global Change: Studies in Two Species of Coastal Marine Invertebrates*  
...
## Publications 
10\. Cai T^†^, Bogan SN, Tanner RL, Kelley JL, and Dowd WW. 2026. Tissue-specific plasticity of DNA methylation across intertidal microhabitats in juvenile mussels (*Mytilus californianus*). *Molecular Ecology* 35: e70418.

9\. Moosman OW\*, Kelley JL, and Bogan SN. 2026. Mitigating Assembly and Switch Errors in Phased Genomes of Polar Fishes Reveals Haplotype Diversity in Copy Number of Antifreeze Protein Genes. *Heredity* 135: 174-186.


8\. Bogan SN, Surendran N\*, Hotaling S, Desvignes T, Bista I, Lins LSF, Eilertsen MH, Le François NR, Algayer T, Hamilton SL, Hoffmann FG, and Kelley JL. 2025. Temperature and Pressure Shaped the Evolution of Antifreeze Proteins in Polar and Deep Sea Zoarcoid Fishes. *Molecular Biology and Evolution*: msaf219.


7\. Bogan SN, Porat OI\*, Meneses MJ\*, and Hofmann GE. 2024. Thermal Plasticity Has Greater Fitness Costs among Thermally Tolerant Genotypes of *Tigriopus californicus*. *Functional Ecology* 38(7):1562–1577.  


6\. Bogan SN and Yi SV. 2024. Potential Role of DNA Methylation in Plastic Responses to the Environment across Cells, Organisms, and Populations. *Genome Biology and Evolution* 16(2): evae022.  


5\. Bogan SN, Johns JW, Griffiths JS, Davenport DL, Schaal SM, Wuitchik SJS, Lotterhos KE, Lou RN, McGirr JA, Downey-Wall AM, Rivera HE, Roberts SB, Puritz JB, and Silliman KE. 2023. A dynamic web resource for robust and reproducible genomics in nonmodel species: marineomics.io. *Methods in Ecology and Evolution* 14(11): 2709–2716.  


4\. Bogan SN, Strader ME, and Hofmann GE. 2023. Associations between DNA Methylation and Gene Expression Depend on Chromatin Accessibility during Transgenerational Plasticity. *BMC Biology* 21:149.  


3\. Bogan SN, Johnson KM, and Hofmann GE. 2020. Changes in Genome-wide Methylation and Gene Expression in Response to Future pCO₂ Extremes in the Antarctic Pteropod *Limacina helicina antarctica*. *Frontiers in Marine Science* 6:788.  


2\. Bogan SN and Place SP. 2019. Accelerated Evolution at Chaperone Promoters among Antarctic Notothenioid Fishes. *BMC Evolutionary Biology* 19:205.  


1\. Bogan SN, McMahon JB, Pechenik JA, and Pires A. 2019. Legacy of Multiple Stressors: Ocean Acidification and Nutrition in Larvae and Juveniles of a Marine Gastropod. *Biological Bulletin* 236(3):159–173.  
...
- Tashi E\*, Bogan SN, Lugardo L, Webber J, Boston L, Grimwood J, Harkess A, and Kelley JL. A chromosome-scale genome of the elusive Hubbs' beaked whale reveals demography, inbreeding, and introgression in *Mesoplodon*. (in review) 
...
- 2026 — 2030 — Gordon and Betty Moore Foundation Grant ($1,377,927). "An open science ecosystem for enabling macrogenomic research in the sea". Co-PI. Lead PI: Katie Lotterhos, Northeastern University. (selected for support)
...
- 2026 — Depth and genome size shaped adaptation to freezing in polar fishes. University of California, Berkeley, Museum of Vertebrate Zoology (invited seminar).
...
- 2026 — An assembly graph permutation test to detect variation cased by haplotype misassembly. Bay Area Population Genomics, University of California Davis, CA (talk).
- 2026 — A thermal gradient in genome size influenced adaptation to freezingin polar fishes. Society of Integrative and Comparative Biology Annual Meeting, Portland, OR (talk).
...
- 2025 — 2028 — Participant, Computational Biology Peer Mentorship Network (CompBioPMN)
  - Participate in pedagogical and research-mentorship training for early career computational faculty at primarily under graduate institutions. CompBioPMN is led by Professor Anna Ritz, Reed College. 

- 2025 — Instructor, Northeastern University, Three Seas Masters in Marine Biology at Friday Harbor Labs, WA  
...
- 2025 – 2026 Kashish Sharma, Undergraduate Student Researcher, UC Santa Cruz
- 2025 Massimo Reyna, Undergraduate Student Researcher, UC Santa Cruz
- 2024 – 2026	Tina Cai, Graduate Student Researcher (PhD), UC Santa Cruz
- 2024 – 2025	Owen Moosman, Undergraduate Researcher, UC Santa Cruz
- 2024 – 2026	Emma Tashi, Undergraduate Researcher, UC Santa Cruz
